...
On non-Windows platforms these are no-ops: under systemd, KillMode=control-group
provides the equivalent guarantee (all children die with the service cgroup).
"""
...
if os.name == "nt":
    ...
    def create_job_object() -> None:
        """No-op off Windows — systemd KillMode=control-group handles child cleanup."""
