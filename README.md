...
A self-hosted NVR (Network Video Recorder) built with FastAPI and Flutter. Designed for 24/7 recording of RTSP cameras with live view, timeline playback with trickplay thumbnails, motion detection, and AI object detection. Free and open source - no cloud, no subscriptions.
